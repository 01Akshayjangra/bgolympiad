...
const PrincipalRegistrationScreen = ({ navigation }) => {
  const {
    firstName,
    setFirstName,
    lastName,
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Card for text */}
      <View style={styles.card}>
        <Text style={styles.registrationText}>Principal Registration</Text>
      </View>
      <ScrollView contentContainerStyle={styles.scontainer}>
        ...
        <TouchableOpacity style={styles.saveButton} onPress={handlePrincipalRegistration}>
          <Text style={styles.buttonText}>Save</Text>
        </TouchableOpacity>

        <View style={styles.Notestyle}>
          <Text style={styles.Notetxt}>Please Note:</Text>
          <Text>Value of your likes as judge.</Text>
          <Text>Like = 10</Text>
          <Text>Super Like = 50</Text>
          <Text>Excellent = 100</Text>
        </View>
      </ScrollView>
    </View>
  );
...
export default PrincipalRegistrationScreen;
