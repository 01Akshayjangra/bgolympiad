  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        <TouchableOpacity
          style={[styles.card, selectedOption === 'student' && styles.selectedCard]}
        ...
        <TouchableOpacity
          style={[styles.card, selectedOption === 'teacher' && styles.selectedCard]}
        ...
        <TouchableOpacity
          style={[styles.card, selectedOption === 'principal' && styles.selectedCard]}
