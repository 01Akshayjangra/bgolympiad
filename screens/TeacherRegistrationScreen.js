...
const TeacherRegistrationScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Card for text */}
      <View style={styles.card}>
        <Text style={styles.registrationText}>Teacher Registration</Text>
      </View>
      <ScrollView contentContainerStyle={styles.scontainer}>
        ...
        <TouchableOpacity style={styles.saveButton} onPress={handleTeacherRegistration}>
